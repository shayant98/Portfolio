  ...
  return (
    <div className={` bg-navy-normal relative min-h-screen  h-full`}>
      <Head>
        ...
        <meta property="og:image" content="https://shayantsital.com/og.png"></meta>
        <meta name="twitter:card" content="summary_large_image"></meta>
        <meta name="twitter:creator" content="@ShayantSital"></meta>
        <meta name="twitter:title" content="Shayant Sital"></meta>
        <meta
          property="twitter:description"
          content="Shayant Sital is a software engineer specializing in building (and occasionally designing) exceptional websites, applications, and everything in between."
        />
        <meta name="twitter:image" content="https://shayantsital.com/og.png" />
      </Head>
