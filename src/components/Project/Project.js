...
const Project = ({ project, flip = false }) => {
  return (
    <>
      {/* /Mobile Design */}
      <div className="group flex relative h-max md:pt-24 cursor-pointer lg:hidden">
        ...
        <div className="absolute z-40 p-4 w-full">
          ...
          <p className="leading-6 tracking-wide text-md text-blue-200 w-64">
            {project.description}
          </p>
          <ul className="inline-flex space-x-4 wrap text-blue-200 font-mono text-xs mt-4">
      ...
      {/* Large Screen */}
      <div className="group relative  h-max pt-24 cursor-pointer hidden xl:flex ">
        <div className={`relative z-0 ${flip && "order-last"}`}>
          <img
            src="./images/covid.png"
            alt="headhsot"
