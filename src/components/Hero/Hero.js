    ...
    <>
      <div className="text-left">
        ...
        <motion.a
          ...
          transition={{ delay: 1.3, duration: 0.5 }}
          href="/"
          className="flex justify-between w-44 mt-10 px-6 py-4 cursor-pointer border-solid border-2 rounded-sm border-red-400 text-red-400  text-lg hover:bg-red-400 hover:bg-opacity-25
