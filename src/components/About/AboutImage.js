...
const AboutImage = () => {
  ...
  return (
    <motion.div
      ...
      className="group relative h-64 mx-auto w-max lg:ml-5 mt-10 md:mt-0 transition ease-in duration-100"
    >
      <LazyLoadImage
        src="./images/portrait.webp"
        alt="headshot wearing yellow shirt"
        className="z-10 relative  w-64 h-64 md:w-96 lg:w-96   object-cover object-top rounded-sm"
      />
