  ...
  return (
    <div className="grid  lg:grid-cols-2 gap-4">
      ...
      <div className="group relative h-64 lg:h-80 w-max place-self-center cursor-pointer transition ease-in duration-100">
        ...
        />
        <div className="h-full w-full z-0 absolute top-0 z-20 bg-opacity-75 bg-red-400 rounded-md group-hover:bg-opacity-0 transition ease-in duration-300"></div>
        <div className="h-full w-full z-0 absolute top-4 left-4 lg:top-10 lg:left-10 border-4 border-navy-light rounded-md group-hover:border-red-400  transition ease-in duration-400"></div>
      </div>
    </div>
  );
};
