  ...
  return (
    <div className="fixed left text-white bottom-0 right-5 w-12  hidden md:block" aria-orientation="vertical">
      <div className="flex flex-col items-center relative">
        <a href="mailto:me@shayantsital.com" className="writing-mode-vertical font-mono text-xs leading-5 tracking-widest hover:text-red-400 transition delay-300 ease-in">
          me@shayantsital.com
        </a>
