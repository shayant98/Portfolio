  ...
  return (
    <>
      <motion.nav
        ...
        className={`flex  justify-between items-center bg-navy-normal bg-opacity-50  fixed  w-screen  h-16 lg:h-max    font-mono text-white text-md px-3 lg:px-12 lg:py-2  z-40`}
      >
        ...
        <motion.div className="px-8 py-2  hidden lg:flex items-center ">
